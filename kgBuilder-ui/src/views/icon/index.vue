<template>
  ...
  <div class="main">
     <remote-css rel="shortcut icon" href="//img.alicdn.com/imgextra/i2/O1CN01ZyAlrn1MwaMhqz36G_!!6000000001499-73-tps-64-64.ico" type="image/x-icon"></remote-css>
  <remote-css rel="icon" type="image/svg+xml" href="//img.alicdn.com/imgextra/i4/O1CN01EYTRnJ297D6vehehJ_!!6000000008020-55-tps-64-64.svg"></remote-css>
  <remote-css rel="stylesheet" href="https://g.alicdn.com/thx/cube/1.3.2/cube.min.css"></remote-css>
    ...
    <div class="nav-tabs">
      ...
      <a href="https://www.iconfont.cn/manage/index?manage_type=myprojects&projectId=3401951" target="_blank" class="nav-more">查看项目</a>
...
<pre><code class="language-html">&lt;span class="iconfont icon-xxx"&gt;&lt;/span&gt;
      ...
      <div class="content symbol">
          <ul class="icon_lists dib-box">
            ...
            <li class="dib">
                <svg class="icon svg-icon" aria-hidden="true">
                  <use xlink:href="#icon-shouhuoicon"></use>
                </svg>
                <div class="name">收货icon</div>
                <div class="code-name">#icon-shouhuoicon</div>
            </li>
